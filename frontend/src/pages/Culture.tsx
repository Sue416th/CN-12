...
const AI_WELCOME =
  ...
  "Hello! I'm your cultural guide assistant. I can introduce the history, culture, and travel tips of famous Chinese attractions like West Lake, Lijiang Ancient Town, and Phoenix Ancient Town. What would you like to know?";
  ...
  return (
    ...
    <div>
      ...
      <div className="relative h-72 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-ba ckground/90 via-background/40 to-transparent" />
      ...
      <div className="container max-w-6xl mx-auto px-6 py-10">
        ...
        >
          ...
          <div className="rounded-2xl bg-card border border-border/50 shadow-lg overflow-hidden h-[450px] flex flex-col w-full mx-auto">

            {/* 对话内容区 */}

            <div className="flex-1 p-6 pb-4 overflow-y-auto max-h-[500px]" ref={messagesContainerRef} onScroll={handleScroll}>
            ...
            <div className="p-4 pt-0 flex gap-3 items-center border-t border-border/50 bg-muted/30">
              ...
              <input
                ...
                placeholder="Please enter the cultural attractions you would like to know about..."

                className="flex-1 rounded-xl border border-input bg-background px-4 py-3 text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 transition-shadow"
